...
embargo, la Comisión Económica para América Latina y el Caribe (CEPAL) ha enfatizado
que estos avances están encontrando límites, ya sea para sostenerse o para
expandirse, y que la región debe enfrentar los desafíos que representa el cierre de las
brechas originadas por la heterogeneidad estructural, la vulnerabilidad externa y la
persistencia de altos niveles de desigualdad. Los pueblos indígenas forman parte de los
...
región, sino un proceso global. La tenaz resistencia de los pueblos indígenas se expresa
actualmente en la instauración de un nuevo estado de cosas en lo político y lo
territorial, así como de nuevos modos de relación institucional entre los Estados y
dichos pueblos. La Declaración de las Naciones Unidas sobre los Derechos de los
Pueblos Indígenas ha sido el corolario de las prolongadas luchas indígenas y sintetiza el
estándar internacional, obligatorio para los Estados, ofreciendo un marco normativo
explícito como enfoque para las políticas públicas. Si bien en este libro se registran
progresos indudables en materia de la aplicación de estos derechos, por otro lado se
constata que las brechas persisten y que las desigualdades continúan siendo
profundas. Uno de los mayores desafíos que enfrenta la región en su búsqueda de la
igualdad es la inclusión de los derechos de los pueblos indígenas entre las prioridades
de las políticas. Los retos son enormes, si se considera que en la región, como se
examina en este estudio, existen más de 800 pueblos indígenas, con una población
cercana a los 45 millones de personas, que se caracterizan por su amplia diversidad
demográfca, social, territorial y política, e incluyen desde pueblos en aislamiento
voluntario hasta pueblos que están presentes en grandes asentamientos urbanos. A
esto se agrega que el crecimiento económico registrado en la región es altamente
dependiente de los recursos naturales y de sus precios internacionales, al mismo
tiempo que se observa una débil gobernanza de estos recursos. La reprimarización de
la economía ha ocasionado fuertes presiones sobre los territorios de los pueblos
indígenas y ha desencadenado numerosos confictos socioambientales todavía no
resueltos. La propuesta actual de la CEPAL, plasmada en los documentos presentados
en sus períodos de sesiones de 2010, 2012 y 20141 , es la de un desarrollo centrado en
el valor de la igualdad con un enfoque de derechos. Asimismo, hemos señalado que es
necesario rediseñar los equilibrios entre el Estado, el mercado y la sociedad para
...
ancestrales, las innovaciones y las prácticas tradicionales de los pueblos indígenas para
la conservación y la utilización sostenible de la diversidad biológica, así como el
desarrollo de las diferentes modalidades colectivas de las economías indígenas,
ofrecen una oportunidad valiosa para la construcción de un nuevo paradigma de
desarrollo, basado en un cambio estructural hacia la igualdad y la sostenibilidad. Es
fundamental el reconocimiento del aporte de los pueblos indígenas en la superación
de los retos que trae consigo el porvenir de nuestra región. En 2014, se llevó a cabo la
reunión de alto nivel conocida como Conferencia Mundial sobre los Pueblos Indígenas,
en la que los Estados Miembros de las Naciones Unidas aprobaron un documento fnal
histórico, en el que renovaron su compromiso con la plena realización de los derechos
de dichos pueblos. En 2015, la comunidad internacional aprobó la Agenda 2030 para el
Desarrollo Sostenible y sus 17 Objetivos de Desarrollo Sostenible (ODS), con el
compromiso de que nadie se quede atrás. Para cumplir con estos acuerdos, es preciso
visibilizar nuestra genuina diversidad; de allí el título de este libro. En este contexto,
resultan imprescindibles las voluntades políticas que permitan avanzar en el cabal
cumplimiento de los derechos humanos de los pueblos indígenas, incluidos las
...
región y el orbe, sentando bases más sólidas para la paz mundial.</p>`,
img:"imagenes/encuentroFeminista.jpg"},
{titulo:"Mapuches",concepto:`<p>
Los mapuches (del autónimo en mapudungún mapuche) o araucanos (nombre dado por los españoles a los indígenas que habitaban la región histórica de Arauco) son un pueblo amerindio que habita en Chile y Argentina.
...
El sistema económico tradicional, basado en la caza y la horticultura, dio paso a una economía agrícola y ganadera en los siglos XVIII y XIX, convirtiéndose en un pueblo campesino luego de la radicación forzosa en terrenos asignados por Chile y Argentina, que actualmente presenta español. una gran fragmentación cultural, una subdivisión de la propiedad y una migración hacia las grandes ciudades por parte de las generaciones más jóvenes, de modo que la población es mayoritariamente urbana, la cual vive principalmente en Santiago de Chile y Temuco, aunque vinculada en diferentes grados con sus comunidades de origen.
La población mapuche sufre discriminación racial y social en sus relaciones con el resto de la sociedad, y según estadísticas oficiales, sus índices de pobreza son mayores que el promedio nacional chileno. Tanto en Argentina como en Chile, algunas iniciativas de recuperación de sus tierras históricas se han encontrado con la negativa de empresas
</p><p>
En Argentina
Desde 1995 el Instituto Nacional de Asuntos Indígenas (INAI) comenzó a reconocer personería jurídica mediante la inscripción en el Registro Nacional de Comunidades Indígenas (Renaci), entre ellas a comunidades mapuches:47​
...
</li><li class="bg-secondary text-white p-2 m-2">En la provincia del Neuquén:
...
</li><li class="bg-secondary text-white p-2 m-2">En la provincia de Río Negro:
...
</li><li class="bg-secondary text-white p-2 m-2">En la provincia de La Pampa:
Comunidad Ranquel Manuel Baigorrita (en el departamento Loventué, el 15 de septiembre de 1999).
</li><li class="bg-secondary text-white p-2 m-2">En la provincia de Mendoza:
...
</li><li class="bg-secondary text-white p-2 m-2">En la provincia de Buenos Aires:
...
</li><li class="bg-secondary text-white p-2 m-2">En la provincia de Santa Cruz:
...
</li><li class="bg-secondary text-white p-2 m-2">En la provincia de Mendoza (mapuches-pehuenches):
...
</li><li class="bg-secondary text-white p-2 m-2">En la provincia de Santa Cruz (mapuches-tehuelches):
Comunidad Nehuen Mulfuñ (en Pico Truncado del departamento Deseado, el 25 de marzo de 2014).48​
</li><li class="bg-secondary text-white p-2 m-2">En la provincia del Chubut (mapuches-tehuelches):
Comunidad Indígena Vuelta del Río (en el departamento Cushamen, el 24 de febrero de 1997).
</li><li class="bg-secondary text-white p-2 m-2">En la provincia de Río Negro (mapuches-tehuelches):
Comunidad Aborigen Río Chico (en el departamento Ñorquincó, el 1 de septiembre de 2000).
</li><li class="bg-secondary text-white p-2 m-2">En la provincia de Buenos Aires (mapuches-tehuelches):
Tehuelche Callvu Shotel (en el partido de La Plata, el 18 de mayo de 2010).
Desde 2009 la provincia de Santa Fe comenzó a registrar a las comunidades indígenas en el Registro Especial de Comunidades Aborígenes de la Provincia de Santa Fe (RECA) del Instituto Provincial de Aborígenes Santafesinos, reconociéndoles en el ámbito provincial la personería jurídica, entre ellas a una comunidad mapuche:49​Comunidad Xavn Inay Leufv (en la ciudad de Rosario del departamento Rosario, el 26 de noviembre de 2015).
</li></ul>
...
Varias organizaciones mapuches [¿quién?] están reclamando el reconocimiento del derecho a la autodeterminación que les corresponde en su calidad de pueblos,114​ según reconoce la Carta de la Organización de las Naciones Unidas.115​ Con la adopción de la Declaración de los Derechos de los Pueblos Indígenas por la Asamblea General de las Naciones Unidas el 13 de septiembre de 2007nota 2​ la comunidad internacional ha reconocido expresamente el carácter de pueblos de los indígenas, como ya lo afirmara el Relator Especial de Naciones Unidas, Miguel Alfonso Martínez, quien en su estudio encargado por esa organización internacional sostuvo que “no he podido hallar argumento jurídico suficiente para que pueda defenderse la idea de que los indígenas han perdido su personalidad indígena internacional como naciones/pueblos”.116​ Actualmente poseen representación en la UNPO.
...
También en el mundo de la cultura no mapuche, su causa ha encontrado eco. Ejemplo de ello son el caso del escritor internacionalista Asel Luzarraga que estuvo detenido;118​ o el de la cineasta Elena Varela, que tras estar detenida posteriormente fue dejada en libertad vigilada;119​ hechos que, para los partidarios de las peticiones mapuches, parecen una ofensiva de Chile para apagar las voces en defensa de este pueblo indígena.120​
Cultura
Su cultura se basa en la tradición oral. La conducta social y religiosa estaba regida por el Admapu (conjunto de antiguas tradiciones, leyes, derechos y normas). Su idioma es el mapudungun, una lengua aglutinante polisintética que hasta ahora no se ha relacionado de modo satisfactorio con ninguna otra.121​ Como deporte tradicional tienen el palín o chueca, un deporte que se presenta más o menos parecido al hockey, y en otros tiempos también al linao, especialmente entre los huilliches.
Entre el patrimonio cultural tangible, se destaca el arte textil y la platería.
Organización social
Su organización y estructura social estaba basada principalmente en la familia y la relación entre ellas, la familia estaba conformada por el padre, sus mujeres y sus hijos. La línea de parentesco más fuerte es la paterna, aunque existen indicios de que en época precolombina pudo haber sido la materna. Las conductas matriomoniales que permite este sistema de parentesco fueron interpretadas por los españoles como una práctica generalizada de incesto.[cita requerida] Actualmente la poligamia tradicional ya no existe entre los mapuches.
...
Reglas de vida familiar[editar]
...
En noviembre de 2007, se llevó a cabo la beatificación del primer mapuche, el joven argentino Ceferino Namuncurá (1886-1905).122​
...
{titulo:"Tehuelches",concepto:``,img:""},
{titulo:"Querandíes",concepto:``,img:""}];
